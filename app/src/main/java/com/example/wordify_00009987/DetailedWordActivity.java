...
//        Cursor word = db.query("dictionary", null, "_id = ?", new String[]{String.valueOf(wordId)}, null, null, null, null);
        ...
        Log.d("testing",String.valueOf(wordId));

//        // get the word details
//        String originalWord = word.getString(word.getColumnIndex("originalWord"));
//        String translation = word.getString(word.getColumnIndex("translation"));
//        String language = word.getString(word.getColumnIndex("language"));
//        String definition = word.getString(word.getColumnIndex("definition"));
//
//        // set word details
